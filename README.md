...
* Verilog HDL Quick Reference Guide ([PDF](https://sutherland-hdl.com/pdfs/verilog_2001_ref_guide.pdf)) by Stuart Sutherland
* Verilog HDL Quick Reference (PDF) by Rajeev Madhavan
* Verilog HDL: A Guide to Digital Design and Synthesis, Second Edition ([PDF](https://d1.amobbs.com/bbs_upload782111/files_33/ourdev_585395BQ8J9A.pdf)) by Samir Palnitkar
* Digital Design with an Introduction to the Verilog HDL (PDF) by M. Morris Mano and Michael D. Ciletti
* FPGA Prototyping by Verilog Examples, Xilinx Spartan-3 Version ([PDF](https://faculty.kfupm.edu.sa/COE/aimane/coe405/FPGA%20Prototyping%20with%20Verilog%20examples.pdf)) by Pong P. Chu
